    ...
    <div class="card-body col">
        <form action="" method="post">
            ...
            <div class="col-auto mb-3">
                ...
                <input type="text" name="umur" value="{{ $dataIbu->umur }}" id="umur" class="form-control" placeholder="Masukkan Umur!">
            </div>
            <div class="col-auto mb-3">
                <label for="agama" class="form-label text-white">Agama</label>
                <select class="form-select" name="agama" aria-label="Default select example">
                    <option selected disabled>{{ $dataIbu->agama }}</option>
            ...
            <div class="col-auto mb-3">
                ...
                <select class="form-select" name="pekerjaan" aria-label="Default select example">
                    <option selected disabled>{{ $dataIbu->pekerjaan }}</option>
                ...
                <div class="col-auto mb-3">
                    ...
                    <textarea class="form-control" name="alamat" id="alamat" rows="3">{!! $dataIbu->alamat !!}</textarea>
                    <div class="col-auto">
                        <div class="col-auto mb-3">
                    ...
                    <div class="col-auto mb-3">
                        ...
                        <select class="form-select" name="provinsi_id" aria-label="Default select example">
                            ...
                            <option value="{{ $pro->id }}" {{ $dataIbu->provinsi_id == $pro->id ? 'selected' : '' }}>
                                {{ $pro->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-auto mb-3">
                        ...
                        <select class="form-select" name="kecamatan_id" aria-label="Default select example">
                            ...
                            <option value="{{ $keca->id }}" {{ $dataIbu->kecamatan_id == $keca->id ? 'selected' : '' }}>
                                {{ $keca->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-auto mb-3">
                        ...
                        <select class="form-select" name="kabupaten_id" aria-label="Default select example">
                            ...
                            <option value="{{ $kabu->id }}" {{ $dataIbu->kabupaten_id == $kabu->id ? 'selected' : '' }}>
                                {{ $kabu->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-auto mb-3">
                        ...
                        <select class="form-select" name="kelurahan_id" aria-label="Default select example">
                            ...
                            <option value="{{ $kelu->id }}" {{ $dataIbu->kelurahan_id == $kelu->id ? 'selected' : '' }}>
                                {{ $kelu->name }}
                            </option>
                            @endforeach
                        </select>
