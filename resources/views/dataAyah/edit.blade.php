...
<div class="card bg-dark mb-5 mt-2">
    <div class="card-body">
        <form action="{{ route('updateAyahs', $dataAyah->id) }}" method="post">
            @csrf
            ...
            <div class="row col-auto mb-3">
                ...
                <div class="col">
                    <input type="radio" name="kewarganegaraan" id="kewarganegaraan" value="WNI" {{ $dataAyah->kewarganegaraan == 'WNI' ? 'checked' : ''}} class="form-check-input">
                    <label for="wni" class="form-label text-white">WNI</label>
                </div>
                <div class="col" style="margin-right: 930px;">
                    <input type="radio" name="kewarganegaraan" id="kewarganegaraan" value="WNA" {{ $dataAyah->kewarganegaraan == 'WNA' ? 'checked' : ''}} class="form-check-input">
